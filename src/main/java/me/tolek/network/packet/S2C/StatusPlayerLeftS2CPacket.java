...
public class StatusPlayerLeftS2CPacket implements Packet<ClientPacketListener> {

    private final String username;

    public StatusPlayerLeftS2CPacket(String username) {
    ...
    public void accept(ClientPacketListener listener, Session ignored) {
        listener.onStatusPlayerLeftS2C(this);
    }
